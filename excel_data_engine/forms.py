...
class ApiForm(forms.Form):
    url_api = forms.CharField(label="Url de la API", widget=forms.TextInput(attrs={"class": "py-1.5 px-3 w-full [background:#212332] outline-none rounded-md focus:[outline-color:#605BFF] focus:outline-1 focus:outline-offset-0 transition-all", "autocomplete":"off", "readonly": ""}))
